...
class StableDiffusionSDSGuidance(BaseObject):
    @dataclass
        ...
        if self.use_controlnet:
            ...
            for i, control_type in enumerate(self.cfg.control_types):
                if control_type == 'normal':
                    ...
                    self.preprocessor_normal = NormalBaeDetector.from_pretrained("lllyasviel/Annotators")
                    ...
                    self.preprocessor_hed = HEDdetector.from_pretrained('lllyasviel/Annotators')

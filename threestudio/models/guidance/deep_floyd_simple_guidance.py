...
@threestudio.register("deep-floyd-simple-guidance")
class DeepFloydSimpleGuidance(BaseObject):
    @dataclass
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if prompt_utils.use_perp_neg:
            ...
            noise_pred_neg, _ = noise_pred[batch_size * 2 : batch_size * 4].split(
                3, dim=1
            )
            noise_pred_null, _ = noise_pred[batch_size * 4 :].split(3, dim=1)
            ...
            noise_pred_null, _ = noise_pred_null.split(3, dim=1)
        ...
        # sds: cond = cfg, uncond = -cfg + 1, null = 0, noise = -1
        # delta: cond = cfg, uncond = -cfg, null = 0, noise = 0
        ...
        if not prompt_utils.use_perp_neg:
            guidance_out.update(
                {
                    ...
                    "null_norm": noise_pred_null.norm(),
